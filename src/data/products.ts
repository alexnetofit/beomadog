...
export const digesticao: Product = {
  ...
  weightLabel: "120g",
  heroImage: "/images/products/digesticao-pote.png",
  heroImageAlt: "Pote de DigestiCão, petisco funcional para cães com complexo probiótico, ômega-3 e enzimas digestivas",
